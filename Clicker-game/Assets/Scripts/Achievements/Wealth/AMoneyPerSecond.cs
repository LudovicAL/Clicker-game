...
public class AMoneyPerSecond : Achievement {
	...
	public AMoneyPerSecond(int id, string name, string description, bool revealed, GameObject aPanel, Image aProgressBar): base (name, description, revealed, aPanel, aProgressBar) {
