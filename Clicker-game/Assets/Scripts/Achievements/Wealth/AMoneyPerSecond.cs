...
public class AMoneyPerSecond : Achievement {
	...
	public AMoneyPerSecond(int id, string name, string description, bool revealed, GameObject aPanel, Image aProgressBar): base (id, name, description, revealed, aPanel, aProgressBar) {
