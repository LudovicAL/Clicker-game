...
public class ALongestSession : Achievement {
	...
	public ALongestSession(int id, string name, string description, bool revealed, GameObject aPanel, Image aProgressBar): base (id, name, description, revealed, aPanel, aProgressBar) {
